...
from app.business_intelligence.config import RESULTS_FOLDER, TARGET_FIELDS
...
def show_merge_preview():
    ...
    if approved.empty:
        print("No business intelligence rows marked ready_to_merge = Yes.")
        return

    master_lookup = master.set_index("business_id").to_dict("index")

    print("=" * 80)
    print("Business Intelligence Merge Preview")
    print("=" * 80)
